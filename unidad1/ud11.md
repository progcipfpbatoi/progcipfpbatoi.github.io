...
|||
|-|-|
| ![procés manual vs. l’automatitzat amb un programa](images/ud11_1.jpeg) | **Exemple:** Suposem que volem calcular el salari total dels empleats d'una empresa. Podríem fer-ho manualment sumant les hores treballades per cada empleat, però si tenim centenars de treballadors, la tasca esdevé massa laboriosa. Un programa pot automatitzar aquest procés, llegint les dades des d'un fitxer i fent els càlculs necessaris en qüestió de segons. |
...
|                                                  |                                                                                                                                                                                         |
|--------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|  | 1. Omplir una olla amb aigua. 2. Col·locar l'ou a l'olla. 3. Escalfar l’aigua fins que bulli. 4. Deixar l'ou bullir durant 10 minuts. 5. Retirar l'ou de l'aigua i deixar-lo refredar.  |
|  | 2. Col·locar l'ou a l'olla. 3. Escalfar l’aigua fins que bulli. 4. Deixar l'ou bullir durant 10 minuts. 5. Retirar l'ou de l'aigua i deixar-lo refredar.  |
| ![procés de cuinar un ou dur](images/ud11_3.svg) | 3. Escalfar l’aigua fins que bulli. 4. Deixar l'ou bullir durant 10 minuts. 5. Retirar l'ou de l'aigua i deixar-lo refredar.  |
|  | 4. Deixar l'ou bullir durant 10 minuts. 5. Retirar l'ou de l'aigua i deixar-lo refredar.  |
